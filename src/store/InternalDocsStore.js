...
class InternalDocsStore {
    ...
    async getListUsers() {
        const response = await axios.get(
            `${process.env.REACT_APP_BASE_URL}/api/v1/departments/users?sort=departmentCode,desc,CDTCT,BCNTT,VPCQTCT,BTGTT,BPC%2526QTRR,BTTKH,BCB%2526DVHH,BVTB,BKTKTNB,BTKTH,BTCKT,BTCNS,BDH,HDQT&company_code=CPN7451091748209`,
            {
                headers: {
                    Authorization: `Bearer ${this.access_token}`,
                },
